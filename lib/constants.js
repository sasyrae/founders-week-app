...
export const DEFAULT_CONFIG = {
  ...
  hotelBlockTarget: 25,
  hotelTeamRooms: 9,
  // Single William Vale group booking link (same for everyone; no price shown).
  hotelBookingUrl:
    "https://be.synxis.com/?adult=1&arrive=2026-10-14&chain=23827&child=0&currency=USD&depart=2026-10-16&group=101426FLYB&hotel=79629&level=hotel&locale=en-US&productcurrency=USD&rooms=1",
  // Negotiated William Vale room rates, per night, by attendee type.
  hotelRateFounder: 399,
...
export const SEED_SESSIONS = [
  ...
  { id: "w4", day: "d1", start: "18:00", end: "20:00", title: "Founders Week + AGM Opening Reception", speaker: "", location: "Westlight Semi-Private Terrace", track: "Social", capacity: 0, desc: "Heavy hors d'oeuvres, drinks, and the whole community on one terrace at golden hour. Dinner afterward is on your own — see the Neighborhood Guide for our picks." },
...
/* ── Neighborhood Guide: Things to Do & Shopping ───────────────
   Every link below was verified by loading the actual site. Where a
   place has no stable official store page, we link a Google Maps
   search at its real address instead — always correct, and it gives
   directions and current hours. */
const maps = (q) => "https://www.google.com/maps/search/?api=1&query=" + encodeURIComponent(q);

export const GUIDE_DO = [
  { name: "Domino Park", note: "Waterfront park built on the old sugar refinery — ten-minute walk, unbeatable Manhattan view.", tag: "", url: "https://www.dominopark.com/" },
  { name: "McCarren Park", note: "The neighborhood's backyard, two blocks up. Public tennis courts, $15/hour reservation through NYC Parks — bubbled for winter by mid-October.", tag: "", url: "https://www.nycgovparks.org/parks/mccarren-park" },
  { name: "Padel Haus", note: "Four indoor padel courts — tennis's faster cousin, glass walls, doubles only. Rackets on site, open till 11.", tag: "", url: "https://www.padel.haus/locations/williamsburg" },
  { name: "Vital Climbing", note: "Bouldering, a rooftop, and a sauna. Weeknights till 11.", tag: "", url: "https://www.vitalclimbinggym.com/brooklyn" },
  { name: "Bathhouse", note: "Thermal pools, saunas, and a 120-foot rooftop pool over the skyline. Open till 11:30.", tag: "", url: "https://www.abathhouse.com/williamsburg" },
  { name: "Nitehawk Cinema", note: "Dine-in movie theater — dinner and a film without the commute.", tag: "", url: "https://nitehawkcinema.com/williamsburg/" },
  { name: "Brooklyn Brewery", note: "The original Williamsburg craft brewery — tasting room, no reservations, no attitude.", tag: "", url: "https://brooklynbrewery.com/visit-us/" },
];

export const GUIDE_SHOP = [
  { name: "Suitsupply", note: "On the corner from The William Vale — suits, made-to-measure, and a fast fix if you forgot a jacket.", tag: "", url: "https://suitsupply.com/en-us/stores/nywilliamsburg" },
  { name: "Ganni", note: "Danish ready-to-wear with a back garden.", tag: "", url: maps("Ganni 113 N 7th St Brooklyn NY") },
  { name: "Uniqlo", note: "The new Williamsburg flagship on Kent — basics, restocked.", tag: "", url: maps("Uniqlo 187 Kent Ave Brooklyn NY") },
  { name: "Muji", note: "Japanese everything-you-forgot: stationery, skincare, travel bits.", tag: "", url: "https://info.muji.us/muji-williamsburg/" },
  { name: "Mogutable", note: "Handmade ceramics, teaware, incense. Small shop, high hit rate.", tag: "", url: "https://mogutable.com/" },
  { name: "Catbird", note: "Williamsburg's jewelry institution — tiny store, serious craftsmanship.", tag: "", url: maps("Catbird jewelry Williamsburg Brooklyn NY") },
  { name: "Beacon's Closet", note: "Cavernous secondhand — you'll find nothing or everything, no in-between.", tag: "", url: maps("Beacon's Closet Williamsburg Brooklyn NY") },
  { name: "Amarcord", note: "Curated Italian vintage. Zero digging required.", tag: "", url: maps("Amarcord Vintage Fashion Williamsburg Brooklyn NY") },
  { name: "Spoonbill & Sugartown", note: "Art, design, and architecture books. Weeknights till 9.", tag: "", url: maps("Spoonbill & Sugartown Books 218 Bedford Ave Brooklyn NY") },
  { name: "Quimby's", note: "Zines, comics, and things you won't find anywhere else.", tag: "", url: maps("Quimby's Bookstore NYC Williamsburg Brooklyn") },
  { name: "Awoke Vintage", note: "Well-organized vintage with actual sizes on the racks.", tag: "", url: maps("Awoke Vintage Williamsburg Brooklyn NY") },
];
