...
export const DEFAULT_CONFIG = {
  ...
  slackChannel: "#founders-week",
  hotelBlockTarget: 25,
  hotelTeamRooms: 9,
  hotelBookingUrl: "",
  blockNights: ["Wed, Oct 14", "Thu, Oct 15"],
  eats: [
    { name: "Leuca", note: "Southern Italian inside The William Vale — you don't even have to put a coat on.", tag: "On-site" },
    { name: "Cafe Mogador", note: "Williamsburg institution — Moroccan-Middle Eastern, always humming.", tag: "" },
    { name: "The Commodore", note: "Legendary dive energy, great fried chicken.", tag: "Late night · kitchen til 1 AM" },
    { name: "Wei", note: "Sichuan dining with killer cocktails and an even better playlist.", tag: "Late night · kitchen til 1 AM" },
    { name: "Laser Wolf", note: "Israeli grill with a rooftop and a point of view.", tag: "" },
    { name: "Le Crocodile", note: "French brasserie at the Wythe — for a proper sit-down.", tag: "" },
    { name: "Santa Fe BK", note: "New Mexican — green chile everything.", tag: "" },
    { name: "Ace's Pizza", note: "Detroit-style squares, zero pretense.", tag: "" },
    { name: "Rule of Thirds", note: "Japanese, beautiful room, great for groups.", tag: "" },
  ],
  days: [
...
export const SEED_SESSIONS = [
  ...
  { id: "f3", day: "d3", start: "10:00", end: "10:55", title: "M&A: Exits in the AI Era", speaker: "", location: "Vale Ballroom", track: "Capital", capacity: 0, desc: "Acquisitions, secondaries, and liquidity when the market is moving fast — founders who've just done deals, plus the banker and lawyer view." },
  { id: "f4", day: "d3", start: "11:00", end: "11:55", title: "The Fundraising Landscape: State of Venture in the AI Age", speaker: "", location: "Vale Ballroom", track: "Capital", capacity: 0, desc: "Marquee Series A investors on what's getting funded now." },
  { id: "f5", day: "d3", start: "12:00", end: "13:00", title: "Fundraising Workshop: Seed to Series A", speaker: "Led by Flybridge", location: "Vale Ballroom", track: "Capital", capacity: 0, desc: "Founder-practical: metrics, narrative, and running the raise, with founders who just did it. Program wraps at 1:00 PM." },
];
...
Join the community: #founders-week is where attendees are connecting before the event, coordinating dinner crews, and getting real-time updates.
{slack}

You can update your schedule anytime — just open the event app and tap "Find my registration."
